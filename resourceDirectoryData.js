 /**
 * Builds static test data
 * @return {object} All relevant data to do demo or test the site.
 */
var siteTestData = function  () {
  var displayList = [{image: 'https://lorempixel.com/400/200/fashion/1', header: 'David Byrne Addresses the Current Economic Crises Facing the Arts', snippet: 'David Byrne\'s What Good Are the Arts responds to the proposed Trump administration budget cuts and an address Byrne gave at his local City Hall. Read an excerpt of his article below:'},
       {image: 'https://lorempixel.com/400/200/people/1', header: 'A web archiving tool for regular users', snippet: 'Rhizome has launched a new user-friendly web archiving application, Webrecorder Player, and now wants to empower regular users to take ownership of the web archiving process, and to take better grasp of access.'},
       {image: 'https://lorempixel.com/400/200/nightlife/1', header: 'Brian Chippendale Discusses Living and Organizing Artist-DIY Spaces', snippet: 'Chippendale recalls his time spent with Fort Thunder, an independent DIY space in Providence, Rhode Island. Find an excerpt of the article below and read the entire essay at The Creative Independent.'}
  ]

  var displayList2 = [{image: 'https://dummyimage.com/400x200/735773/c5c6d1.jpg&text=Something+Graphical+Here', header: 'David Byrne Addresses the Current Economic Crises Facing the Arts', snippet: 'David Byrne\'s What Good Are the Arts responds to the proposed Trump administration budget cuts and an address Byrne gave at his local City Hall. Read an excerpt of his article below:'},
      {image: 'https://dummyimage.com/400x200/735773/c5c6d1.jpg&text=Something+Graphical+Here', header: 'Peter Piper picked a peck of Pickled Peppers', snippet: 'Doaifdjf dsaiofdjisoa fjdoispafjidop ijdospafjdiosafpsifdpsjfiaop ifopdagjifodagp fiodpagjf agijfop dagjifo dpsgjifodpsgjf dsopigjf dsiog fdiosg fosg '},
      {image: 'https://dummyimage.com/400x200/735773/c5c6d1.jpg&text=Something+Graphical+Here', header: 'The little engine that could but didn\'t', snippet: 'The itsy bitsy spider sadlfjd skla f;djk s;afj dksla;fjd sk;afj dkls; afjkdl ;safjkd l;safj dkl;sa fjkdl;s afjkdl ;safjkdl ;safjkdl;s afjkdl s;afj kdls; afjkdls;a fjkdl'}
  ]

  var displayList3 = [{image: 'https://lorempixel.com/400/200/fashion/3', header: 'No Lugar Que Tem Paranha, Jacaré nada de costa', snippet: 'David Byrne\'s What Good Are the Arts responds to the proposed Trump administration budget cuts and an address Byrne gave at his local City Hall. Read an excerpt of his article below:'},
      {image: 'https://lorempixel.com/400/200/people/3', header: 'Eeh eeehheeeeheeeeeheeeeheeh', snippet: 'dksjal;f djkslaf ;djklsa ;fjdks ;afjkdls; afjkdls; afjkdl;safjkld; agjkdl;saf jkdls;fdsf'},
  ...
  const data = {
    tableData: [{section: 'call for artists',
      latest: displayList,
    ...
    search: '',
    description: 'Community Resource        committed to sustaining vibrant and accessible artistic communities',
